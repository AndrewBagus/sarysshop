...
class m_customer_categoryModel extends CI_Model
{
  public function getTable($limit, $start)
  {
    ...
    $get_table = $this->db->get('m_kategori_pelanggan', $limit, $start);
  ...
  public function insertData()
  {
    ...
    $this->db->insert('m_kategori_pelanggan', $data);
  }
  ...
  //   ];
  //   $this->db->where('id', $id);
  //   $this->db->update('m_kategori_pelanggan', $data);
  // }
