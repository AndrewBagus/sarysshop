            ...
            <form id="form_creator" class="form-horizontal" action="#">
              <div class="form-body">
                ...
                <fieldset class="col-sm-6">
                  <h5>Tanggal</h5>
                  <div class="input-group input-group-lg">
                    <input type="text" name="date" id="date" class="form-control cannot-null" placeholder="Format tanggal (dd-MM-yyyy)" value="<?= set_value('date') ? set_value('date') : date('d-m-Y'); ?>">
                ...
                <fieldset class="col-sm-8">
                  <h5>Biaya</h5>
                  <div class="input-group input-group-lg">
                    <input id="biaya" name="biaya" class="form-control cannot-null format_currency" type="text" value="<?= set_value('biaya'); ?>" />
                    <span class="text-danger"></span>
                ...
                <fieldset class="col-sm-4">
                  <h5>Jumlah</h5>
                  <div class="input-group input-group-lg">
                    <input id="jumlah" name="jumlah" class="form-control positive-integer cannot-null positive-integer" type="text" value="<?= set_value('jumlah'); ?>" />
                    <span class="text-danger"></span>
                ...
                <fieldset class="col-sm-12">
                  <h5>Keterangan</h5>
                  <div class="input-group input-group-lg">
                    <textarea id="keterangan" name="keterangan" rows="3" class="form-control cannot-null" type="text"><?= set_value('keterangan'); ?></textarea>
                    <span class="text-danger"></span>
              ...
              <div class="form-actions">
                ...
                <div class="text-xs-right col-md-4 row">
                  <h3>Rp <span id="nilai_total">0</span></h3>
                </div>
              </div>
