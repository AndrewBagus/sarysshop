  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <div class="form-group mt-3">
        ...
        <div class="input-group">
          <input type="text" class="form-control" id="tgl-order" name="tgl_order" placeholder="Tanggal Order" data-toggle="datetimepicker" data-target="#tgl-order" style="border-right: 0;">
