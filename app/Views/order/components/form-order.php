          ...
          <tr>
            <td colspan="3">
              <div id="btn-wrapper-additionl" class="ps-0 my-2" style="display: flex; gap: 5px; flex-wrap: wrap;">
                  ...
                  <button class="btn btn-outline-success btn-sm" id="btn-gobal-additional" data-bs-toggle="tooltip" data-bs-title="Biaya Lain"><i class="fa fa-plus"></i> Biaya Lain</button>
